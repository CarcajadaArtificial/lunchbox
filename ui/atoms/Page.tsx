 ...
 */
export const Body = (p: iAtom<HTMLBodyElement>): JSX.Element => (
  <body
    {...p}
    class={cn(
      'font-base',
 ...
 */
export const Main = (p: iAtom<HTMLElement>): JSX.Element => (
  <main
    {...p}
    class={cn(
      clr.page.bg,
 ...
 */
export const Header = (p: iAtom<HTMLElement>): JSX.Element => (
  <header
    {...p}
    class={cn(
      area,
 ...
 */
export const Footer = (p: iAtom<HTMLElement>): JSX.Element => (
  <footer
    {...p}
    class={cn(
      area,
